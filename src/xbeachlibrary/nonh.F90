...
contains
   ...
   subroutine nonh_1lay_cor(s,par)
      ...
      use spaceparams
      use params,         only: parameters
      use solver_module,  only: solver_solvemat
      use xmpi_module
      !--------------------------     ARGUMENTS          ----------------------------
   ...
   subroutine nonh_1lay_pred(s,par)
      ...
      use spaceparams
      use params,                  only: parameters
      use flow_secondorder_module, only: flow_secondorder_advw
      !--------------------------     ARGUMENTS          ----------------------------
   ...
   subroutine nonh_2lay_pred_3d(s,par,uu0,vv0)
      ...
      if (par%nhlay > 0.) then
         ...
         !
         do j=jmin_uu,jmax_uu  ! Robert: was do j=2,s%ny-1
            !
            do i=imin_uu,imax_uu
               !
