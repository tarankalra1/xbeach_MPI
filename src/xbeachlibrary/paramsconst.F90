module paramsconst
   ...
   integer, parameter :: TIDETYPE_HYBRID             =  2
   ...
   integer,parameter  :: TRUNCATIONTYPE_ABSOLUTE      = 0
   integer,parameter  :: TRUNCATIONTYPE_RELATIVE      = 1
   integer,parameter  :: TRUNCATIONTYPE_ABSOLUTE_EE   = 2
   integer,parameter  :: TRUNCATIONTYPE_RELATIVE_EE   = 3
