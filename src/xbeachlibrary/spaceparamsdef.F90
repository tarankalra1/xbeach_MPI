module spaceparamsdef
   ...
   integer, public :: imin_ee,imax_ee,jmin_ee,jmax_ee
   integer, public :: imin_uu,imax_uu,jmin_uu,jmax_uu
   integer, public :: imin_vv,imax_vv,jmin_vv,jmax_vv
   integer, public :: imin_zs,imax_zs,jmin_zs,jmax_zs
