...
contains
   ...
   subroutine flow_secondorder_con(s,par,zs_old)
      ...
      !Update fluxes
      if (s%ny>0) then
         s%qx(imin_uu:imax_uu,jmin_uu:jmax_uu) = s%qx(imin_uu:imax_uu,jmin_uu:jmax_uu) +wrk1(imin_uu:imax_uu,jmin_uu:jmax_uu)
         s%qy(imin_vv:imax_vv,jmin_vv:jmax_vv) = s%qy(imin_vv:imax_vv,jmin_vv:jmax_vv) +wrk2(imin_vv:imax_vv,jmin_vv:jmax_vv)
      else
         s%qx(imin_uu:imax_uu,jmin_uu:jmax_uu) = s%qx(imin_uu:imax_uu,jmin_uu:jmax_uu) +wrk1(imin_uu:imax_uu,jmin_uu:jmax_uu)
      endif
   ...
   subroutine flow_secondorder_huhv(s,par)
      ...
      if (s%ny > 0) then
         ...
         do j= jmin_uu , jmax_uu
            !
            do i = imin_uu, imax_uu ! Robert: was 1 , s%nx
               !
               ie  = min(i+1,imax+1)
               iee = min(i+2,imax+1)
               iw  = max(i-1,1)
         ...
         do j= jmin_vv,jmax_vv ! Robert: was 1,s%ny
            !
            ie  = min(j+1,jmax+1)
            iee = min(j+2,jmax+1)
            iw  = max(j-1,1)
         ...
         !
         j= 1
         do i=imin_uu, imax_uu ! Robert: was 1,s%nx-1
            !
            ie  = min(i+1,imax+1)
            iee = min(i+2,imax+1)
            iw  = max(i-1,1)
